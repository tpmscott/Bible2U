...
var Book_Verse_Count_Value = 13;  // for Bible4U set 25, Bible2U set 13, Test set 5
...
async function Show_Recent_ML_Only() {   // New for V4
  ...
  let Verse = await dbT2.books.orderBy('date').reverse().limit(30).toArray();  // order by chap_no, from big to small
                                                                                // Recent 30
   var text1;
...
function copyFunction5(arg1) {  // New for V5
      ...
      select_all_and_copy_V2(document.getElementById("Imp_to_books_Test2Db"),arg1); 
